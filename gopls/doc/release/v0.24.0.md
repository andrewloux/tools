...
MCP reference tools now use compact `path:line:column` entries with source
lines. They retain every reference and include locations even when source
text is unavailable. Lines and UTF-16 columns are one-based.
